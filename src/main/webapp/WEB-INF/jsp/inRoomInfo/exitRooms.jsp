    ...
    <form class="layui-form layui-form-pane" action="" lay-filter="exitInRoomInfoForm" style="margin-left: 50px;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="number" lay-verify="number|otherPrice" id="otherPrice" value="0" autocomplete="off" class="layui-input" placeholder="请输入金额" >
                </div>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item layui-form-text" style="width: 600px;">
            ...
            <div class="layui-input-block">
                <textarea rows="2" placeholder="请输入内容" lay-verify="" name="remark" id="remark" class="layui-textarea"></textarea>
            </div>
        </div>
        <div class="layui-form-item">
